...
@section('content')
    ...
    <div class="mt-3 rounded-2 overflow-hidden">
        <form action="{{route('admin.course.create_post')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-lg-6 mb-3">
                    <div class="bg-white p-3 rounded-3">
                        <div class="mb-3">
                            ...
                            <input type="text" name="Title" value="{{old('Titles')}}" class="form-control" id="" placeholder="Tên khóa học">
                            @error('Title')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="Price" value="{{old('Price')}}" class="form-control" id="" placeholder="Giá khóa học">
                        </div>
                        <div class="mb-3">
                            <label for="" class="form-label fw-semibold">Yêu cầu</label>
                            <input type="text" name="Request" value="{{old('Request')}}" class="form-control" id="" placeholder="Yêu cầu của khóa học">
                            @error('Request')
                                <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" name="Achievement" value="{{old('Achievement')}}" class="form-control" id="" placeholder="Yêu cầu của khóa học">
                            @error('Achievement')
                                <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-select" name="Pro" aria-label="Default select example">
                                <option  value="1" selected>Có trả phí</option>
                ...
                <div class="col-lg-6 mb-3">
                    <div class="bg-white p-3 rounded-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="Video_Intro" value="{{old('Video_Intro')}}" class="form-control" id="" placeholder="Link nhúng iframe :))">
                            @error('Video_Intro')
                                <div class="text-danger">{{$message}}</div>
                            @enderror
                        </div>
